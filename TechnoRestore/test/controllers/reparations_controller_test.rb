...
class ReparationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reparation" do
    assert_difference('Reparation.count') do
      post reparations_url, params: { reparation: { Description: @reparation.Description, FechaF: @reparation.FechaF, FechaI: @reparation.FechaI, PrecioBase: @reparation.PrecioBase, PrecioFinal: @reparation.PrecioFinal, cproduct_id: @reparation.cproduct_id, user_id: @reparation.user_id } }
    end
  ...
  test "should update reparation" do
    patch reparation_url(@reparation), params: { reparation: { Description: @reparation.Description, FechaF: @reparation.FechaF, FechaI: @reparation.FechaI, PrecioBase: @reparation.PrecioBase, PrecioFinal: @reparation.PrecioFinal, cproduct_id: @reparation.cproduct_id, user_id: @reparation.user_id } }
