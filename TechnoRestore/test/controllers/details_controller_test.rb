...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post details_url, params: { detail: { Cantidad: @detail.Cantidad, product_id: @detail.product_id, sale_id: @detail.sale_id } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { Cantidad: @detail.Cantidad, product_id: @detail.product_id, sale_id: @detail.sale_id } }
